...
def translate_text_using_text_davinci(text, src_land, trg_lang):
...
def translate_text_using_text_chatgpt(text, src_land, trg_lang):
...
if st.button("번역"):
    ...
    translated_text = translate_text_using_text_chatgpt(text, src_lang, trg_lang)
